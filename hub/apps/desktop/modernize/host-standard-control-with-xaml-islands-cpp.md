...
4. 在“NuGet 包管理器”窗口的“浏览”选项卡上，搜索 [Microsoft.Toolkit.Win32.UI.SDK](https://www.nuget.org/packages/Microsoft.Toolkit.Win32.UI.SDK) NuGet 包，并安装此包的最新稳定版 。 此包提供了多个版本和运行时资产，可使 XAML 岛在你的应用中正常工作。
