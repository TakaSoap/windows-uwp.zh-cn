...
[Windows UI 库 (WinUI)](../winui/index.md) 是新式的本机用户界面 (UI) 平台，适用于跨桌面（.NET 和本机 Win32）和 UWP 应用平台的 Windows 应用。 [WinUI 3](../winui/winui3/index.md) 是 WinUI 的最新主要版本，它将 WinUI 转换为适用于桌面 Windows 应用的完整 UX 框架。

WinUI 3 作为 [Project Reunion](../project-reunion/index.md) 的一部分提供。 其中包括用于 Visual Studio 2019 的 VSIX 包，此包提供项目和项模板，可帮助你使用基于 WinUI 的界面开始生成应用。

有关安装 Project Reunion VSIX 包和 WinUI 项目模板的说明，请参阅[创建开发环境](../project-reunion/get-started-with-project-reunion.md#set-up-your-development-environment)。 若要详细了解可用的 WinUI 项目和项模板，请参阅[创建 WinUI 3 项目](../winui/winui3/winui-project-templates-in-visual-studio.md)。
