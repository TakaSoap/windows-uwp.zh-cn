---
description: 了解如何创建辅助磁贴，并通过通用 Windows 平台 (UWP) 应用以编程方式将其固定到 "开始" 菜单。
...
> [!IMPORTANT]
> 如果你是使用桌上型计算机的桌面应用程序，则必须先执行其他步骤，如[从桌面应用](secondary-tiles-desktop-pinning.md)程序中固定
