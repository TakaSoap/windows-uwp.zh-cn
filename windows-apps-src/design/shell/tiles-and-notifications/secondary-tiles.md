...
| [从桌面应用固定](secondary-tiles-desktop-pinning.md) | 桌面应用可固定辅助磁贴，但要归功于 Desktop Bridge！ |
...
若要了解如何通过桌面桥使用桌面应用程序中的辅助磁贴，请参阅 [从桌面应用固定辅助磁贴](secondary-tiles-desktop-pinning.md)。
