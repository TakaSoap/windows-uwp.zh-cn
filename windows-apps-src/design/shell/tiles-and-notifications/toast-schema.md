...
如果希望使用原始 XML 而非[通知库](https://www.nuget.org/packages/Microsoft.Toolkit.Uwp.Notifications/)，请参阅 [XML 架构](/uwp/schemas/tiles/toastschema/schema-root)。
...
| **可视** | [ToastVisual](#toastvisual) | true | 描述 toast 通知的可视部分。 |
