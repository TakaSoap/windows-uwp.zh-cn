...
- Windows 10 和 Microsoft Visual Studio 2015 或更高版本。 （建议对当前开发和安全更新使用最新版 Visual Studio）[单击此处了解如何设置 Visual Studio](/windows/apps/get-started/get-set-up)。
