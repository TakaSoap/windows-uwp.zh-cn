...
- 当没有为该语言定义 Suppress-Script 值时，请在限定符中指定语言脚本子标记。 例如，使用 zh-chs、Zh-hant、zh-chs-Zh-hant 或 zh-chs-Hans (来了解更多详细信息，而不是使用 zh-chs 或 zh-chs，请参阅 [IANA 语言](https://www.iana.org/assignments/language-subtag-registry) 子标记注册表) 。
