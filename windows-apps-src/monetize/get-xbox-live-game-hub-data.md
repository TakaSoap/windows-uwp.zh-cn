...
ms.locfileid: "89155551"
---
# <a name="get-xbox-live-game-hub-data"></a>获取 Xbox Live 游戏中心数据


在 Microsoft Store 分析 API 中使用此方法获取你的[支持 Xbox Live 的游戏](/gaming/xbox-live/index.md)的游戏中心数据。 合作伙伴中心的 [Xbox analytics 报告](../publish/xbox-analytics-report.md) 中也提供了此信息。
