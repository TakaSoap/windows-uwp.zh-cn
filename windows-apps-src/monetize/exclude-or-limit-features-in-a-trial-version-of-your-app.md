...
应用的当前许可证状态存储为 [LicenseInformation](/uwp/api/Windows.ApplicationModel.Store.LicenseInformation) 类的属性。 通常，将取决于许可证状态的功能放在我们在下一步介绍的条件块中。 在考虑这些功能时，确保实现该功能的方式允许这些功能在所有许可证状态下均能正常工作。
...
有关描述应用的详细信息，请参阅[创建应用提要](../publish/create-app-store-listings.md)。
