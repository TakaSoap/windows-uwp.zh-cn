---
title: 弹簧动画
description: 了解如何使用 NaturalMotionAnimation Api 在应用中创建弹簧运动体验。
ms.date: 10/10/2017
ms.topic: article
...
![带有 ](images/animation/offset-spring.gif)
 ![ 三次方贝塞尔动画的弹簧动画运动的动作](images/animation/offset-cubic-bezier.gif)
