...
| [设备配对](pair-devices.md) | 某些设备需要先进行配对，然后才能使用。 [  <strong>Windows.Devices.Enumeration</strong>](/uwp/api/Windows.Devices.Enumeration) 命名空间支持三种配对设备的不同方式。 |
...
| [获取电池信息](get-battery-info.md) | 了解如何使用 [<strong>Windows.Devices.Power</strong>](/uwp/api/Windows.Devices.Power) 命名空间中的 API 获取电池的详细信息。 |