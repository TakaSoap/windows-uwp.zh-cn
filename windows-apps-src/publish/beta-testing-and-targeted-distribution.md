---
description: 合作伙伴中心提供几个选项，让测试人员在向公众提供应用之前试用你的应用。
title: Beta 测试和目标分发
...
合作伙伴中心提供几个选项，让测试人员在向公众提供应用之前试用你的应用。
...
仅当尚未向公共受众发布应用程序时，才能使用 " **专用用户** " 选项。 可以将此选项与面向任何操作系统版本的应用一起使用，但测试人员必须运行 Windows 10 版本1607或更高版本 (包括 Xbox One) ，并且必须使用与所提供的电子邮件地址关联的 Microsoft 帐户进行登录。
...
此选项提供了另一种方法，用于将应用程序仅分配给一组特定的测试人员，同时防止其他人在应用商店中发现你的应用 (或在未) 促销代码的情况下获取应用。 但是，与私人受众选项不同，如果有直接链接，任何人都可能看到你的应用的一览。 如果保密性对于你的提交至关重要，我们建议改为发布到私人受众。
