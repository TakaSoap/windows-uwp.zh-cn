...
|---------------------------------------------|-----------------------------|--------------------------------------------------------------------------------------------|----------|
| Nothing                                     | x86，v1.0.0.0               | x86，v1.0.0.0，在 x86 和 x64 计算机上                                                | 哪个位置都不行。 |
| x86，v1.0.0.0                               | x64，v1.0.0.0               | v1.0.0.0，针对客户的体系结构                                                   | 哪个位置都不行。 版本号相同。 |
...
| Nothing                                     | 中性，v1.0.0.1           | 中性，v1.0.0.1，在所有计算机上                                                         | 哪个位置都不行。 |
| 中性，v1.0.0.1                           | x86，v1.0.0.0 <br> x64，v1.0.0.0 <br> ARM，v1.0.0.0 | v1.0.0.0，针对客户计算机的体系结构。          | 哪个位置都不行。 拥有体系结构为 Neutral 的 v1.0.0.1 版本应用的客户将继续使用它。 |
