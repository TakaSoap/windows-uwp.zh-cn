...
ms.locfileid: "93034640"
---
# <a name="age-ratings"></a>年龄分级

[应用提交过程](app-submissions.md)的 " **年龄分级** " 页可让你提供有关你的应用程序的信息，以便它可以接收由 [国际年龄分级联盟 (IARC)](https://www.globalratings.com/)分级系统所管理的适当年龄和内容分级。 这些分级与应用内容的适宜性有关，而与应用的目标受众的年龄无关。
...
回答完问题后，单击 " **保存并生成** "。 然后，你将看到应用的所有已分配分级，并且可以继续提交。 您还可以单击 " **编辑** " 来更正您对调查表的任何答案。

下次更新应用时，你将在该页面上看到应用的所有已分配分级。 你还可以单击 " **编辑** "，以在你的应用程序的内容更改为需要你调整任何答案的方式后重做调查。 IARC 有时还可能会更新问题。 如果发生这种情况，可能会在你提交更新时提示你重新完成填写问卷调查。
