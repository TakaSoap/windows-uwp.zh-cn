---
description: 请参阅帮助 iOS 开发人员开始在 Visual Studio 中创建和发布 UWP 应用的演练文章。
...
ms.locfileid: "89164321"
---
# <a name="getting-started-with-uwp-for-ios-developers"></a>适用于 iOS 开发人员的 UWP 入门


如果你是考虑为 Windows 10 进行开发的 iOS 开发人员，这些文档会是很好的入门文档。 他们将向你介绍你在开始编写应用时需要了解的一些概念，并介绍如何在 Microsoft Store 上发布工作。
...
要开始这些操作实例，你需要一台装有 Windows 10 和 Microsoft Visual Studio 的计算机。 可以从 [适用于 UWP 应用的开发人员下载](https://developer.microsoft.com/windows/downloads)下载这些内容。 没有 PC？ 不要担心，你可以使用 Mac：请参阅[在 Mac 上安装 Windows 和开发人员工具](setting-up-your-mac-with-windows-10.md)。
...
| [入门：导航](getting-started-navigation.md) | 在 Windows 10 应用中管理此导航的方法之一是使用 [Frame](/uwp/api/Windows.UI.Xaml.Controls.Frame) 类。 下面的演练向你展示如何尝试执行此操作。 |
| [入门：动画](getting-started-animation.md) | Windows 应用中的动画可以使用编程方式创建，但也可以使用 Extensible Application Markup Language (XAML) 以声明方式定义。 |
| [入门：接下来怎么做？](getting-started-what-next.md) | 凭借此基本信息，你现在可以开始编写更有趣的通用 Windows 平台 (UWP) 应用。 在后续步骤中，请先通读以下主题，然后启动 Visual Studio 并开始编写代码！ |
| [Windows 应用概念映射](./android-ios-uwp-map.md) | 如何以 Windows（和 Android）功能术语考虑 iOS 概念 |
