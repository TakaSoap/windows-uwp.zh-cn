...
ms.locfileid: "89157253"
---
# <a name="move-to-cwinrt-from-wrl"></a>从 WRL 移动到 C++/WinRT
本主题介绍了如何将 [Windows 运行时 C++ 模板库 (WRL)](/cpp/windows/windows-runtime-cpp-template-library-wrl) 代码移植到 [C++/WinRT](./intro-to-using-cpp-with-winrt.md) 中的等效项。
