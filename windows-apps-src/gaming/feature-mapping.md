...
Direct3D 11 引入了着色器模型5，它需要 Direct3D 功能级别 11 \_ 0 (或更高) 。 请参阅 [Direct3D 11 的 HLSL 着色器模型 5 功能](https://docs.microsoft.com/windows/desktop/direct3dhlsl/overviews-direct3d-11-hlsl)。
