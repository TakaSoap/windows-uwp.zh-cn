...
#### <a name="clipboard"></a>[剪贴板](/uwp/api/windows.applicationmodel.datatransfer.clipboard)
...
#### <a name="control"></a>[控件](/uwp/api/windows.ui.xaml.controls.control)
