...
description: 按照本教程操作，创建适用于 Microsoft Store、用 C# 和 MonoGame 编写的简单 UWP 游戏。
ms.date: 03/06/2017
ms.topic: article
...
+   Windows 10 和 Microsoft Visual Studio 2019。  [单击此处了解如何设置 Visual Studio](./get-set-up.md)。
+ .NET 桌面开发框架。 如果你尚未安装，可以通过重新运行 Visual Studio 安装程序和修改 Visual Studio 2019 安装来获得。
+   C# 或类似面向对象的编程语言的基础知识。 [单击此处以了解如何开始使用 C#](./create-a-hello-world-app-xaml-universal.md)。
...
必须使用应用提交[清单](../publish/app-submissions.md)。

必须将此应用提交以进行[认证](../publish/the-app-certification-process.md)。
